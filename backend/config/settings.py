...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,194.60.231.96,', cast=lambda v: [s.strip() for s in v.split(',')])
...
# --- PostgreSQL config (commented for later use) ---
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': config('DB_NAME', default='insta_analytics'),
...
CSRF_COOKIE_SAMESITE = 'Lax'  # Allow credentials
